defmodule Cocktail.SecondlyTest do
  ...
  test "Secondly" do
    ...
    assert times == [
             ~Y[2017-01-01 06:00:00 PST],
             ~Y[2017-01-01 06:00:01 PST],
             ~Y[2017-01-01 06:00:02 PST]
           ]
  end
  ...
  test "Every 2 seconds / Every 3 seconds" do
    ...
    assert times == [
             ~Y[2017-01-01 06:00:00 PST],
             ~Y[2017-01-01 06:00:02 PST],
             ~Y[2017-01-01 06:00:03 PST],
             ~Y[2017-01-01 06:00:04 PST],
             ~Y[2017-01-01 06:00:06 PST],
             ~Y[2017-01-01 06:00:08 PST],
             ~Y[2017-01-01 06:00:09 PST]
           ]
  end
  ...
  test "Secondly; overridden start time" do
    ...
    assert times == [
             ...
             ~Y[2017-08-01 12:00:01 PDT],
             ~Y[2017-08-01 12:00:02 PDT]
           ]
  end
